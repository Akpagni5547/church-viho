...
;(function (t) {
  ...
  function D(t, n, i) {
    var r
    return (
      (r = null != i ? i.diff(n, t, !0) : e.isDuration(n) ? n.as(t) : n.end.diff(n.start, t, !0)),
      r >= 1 && _(r) ? r : !1
    )
  }
  function C(t) {
  ...
  function he(t, e, n) {
    ...
    if (void 0 === t.forwardCoord)
      for (
        r.length
          ? (r.sort(pe), he(r[0], e + 1, n), (t.forwardCoord = r[0].backwardCoord))
          : (t.forwardCoord = 1),
  ...
  function me(n, r) {
    ...
    function a() {
      ;(se = J.theme ? 'ui' : 'fc'),
        ...
        ie && n.prepend(ie),
        c(J.defaultView),
        J.handleWindowResize && ((ae = G(w, J.windowResizeDelay)), t(window).resize(ae))
    }
    function u() {
      oe && oe.destroyView(),
        ne.destroy(),
    ...
    function U(t, e) {
      return void 0 === e
        ? J[t]
        : (('height' == t || 'contentHeight' == t || 'aspectRatio' == t) && ((J[t] = e), m(!0)),
          void 0)
    }
    function q(t, e) {
    ...
    ;(K.defaultAllDayEventDuration = e.duration(J.defaultAllDayEventDuration)),
      ...
      (K.getDefaultEventEnd = function (t, e) {
        var n = e.clone()
        return (
          t ? n.stripTime().add(K.defaultAllDayEventDuration) : n.add(K.defaultTimedEventDuration),
                    ...
                    (v = t('<button type="button" class="' + m.join(' ') + '">' + g + '</button>')
                      .click(function () {
                        v.hasClass(f + '-state-disabled') ||
                          (l(),
                          (v.hasClass(f + '-state-active') || v.hasClass(f + '-state-disabled')) &&
  ...
  function ye(n) {
    ...
    function L() {
      var e,
        ...
        s = O.getView()
      return (
        i && (e = 'object' == typeof i ? t.extend({}, r, i) : r), e ? H(b(e), s.start, s.end) : []
      )
    }
    function P(t, e) {
      var i = e.source || {},
    ...
    function G(t, e, n, i) {
      var r, s, o, l, a
      if (
        ((t = { start: t.start.clone().stripZone(), end: t.end.clone().stripZone() }), null != e)
      ) {
    ...
    return (
      this.each(function (r, s) {
        ...
        'string' == typeof e
          ? a &&
            t.isFunction(a[e]) &&
            ((o = a[e].apply(a, n)), r || (i = o), 'destroy' === e && l.removeData('fullCalendar'))
  ...
  ;(De.moment = function () {
    ...
    (Me = Re
      ? function (t, n) {
          t._d.setTime(
            +new Date(n[0] || 0, n[1] || 0, n[2] || 0, n[3] || 0, n[4] || 0, n[5] || 0, n[6] || 0)
          ),
            e.updateOffset(t, !1)
        }
      : O)
  ...
  var Oe = K.extend({
    ...
    Ie = K.extend({
      ...
      mousedown: function (t) {
        v(t) &&
          (t.preventDefault(), this.startListening(t), this.options.distance || this.startDrag(t))
      },
        ...
        this.isListening ||
          (e &&
            ...
            n.is(window) ||
              n.is(document) ||
              ((this.scrollEl = n),
              (this.scrollHandlerProxy = G(t.proxy(this, 'scrollHandler'), 100)),
      ...
      mousemove: function (t) {
        ...
        this.isDragging ||
          ...
          (n = Math.pow(t.pageX - this.mouseX0, 2) + Math.pow(t.pageY - this.mouseY0, 2)),
      ...
      drag: function (t) {
        ...
        this.isDragging &&
          ((e = this.getCell(t)),
          Q(e, this.cell) || (this.cell && this.cellOut(), e && this.cellOver(e)),
          this.dragScroll(t))
      },
      cellOver: function (t) {
      ...
      stopDrag: function (t) {
        this.isDragging &&
          (this.stopScrolling(), this.trigger('dragStop', t), (this.isDragging = !1))
      },
    ...
    Xe = (De.Grid = je.extend({
        ...
        var e,
          ...
          o = new Ie(this.coordMap, {
            ...
            cellOver: function (t, r) {
              ...
              l &&
                ((e = r ? t : null),
                s && ((n = i.computeSelection(l, t)), n ? i.renderSelection(n) : a()))
            },
            cellOut: function () {
      ...
      getDayClasses: function (t) {
        var e = this.view,
          ...
          i = ['fc-' + Fe[t.day()]]
        return (
          'month' === e.name && t.month() != e.intervalStart.month() && i.push('fc-other-month'),
          t.isSame(n, 'day')
  ...
  Xe.mixin({
    ...
    triggerSegMouseover: function (t, e) {
      this.mousedOverSeg ||
        ((this.mousedOverSeg = t), this.view.trigger('eventMouseover', t.el[0], t.event, e))
    },
    ...
    documentDragStart: function (e, n) {
      ...
      s.opt('droppable') &&
        ((i = t(e.target)),
        (r = s.opt('dropAccept')),
        (t.isFunction(r) ? r.call(i[0], i) : i.is(r)) && this.startExternalDrag(i, e, n))
    },
    ...
    eventsToRanges: function (e) {
      ...
      return (
        t.each(i, function (t, e) {
          e.length &&
            r.push.apply(r, te(e[0]) ? n.eventsToInverseRanges(e) : n.eventsToNormalRanges(e))
        }),
        r
      )
    },
    eventsToNormalRanges: function (t) {
      ...
      for (e = 0; t.length > e; e++)
        (n = t[e]),
          ...
          o.push({ event: n, start: i, end: r, eventStartMS: +i, eventDurationMS: r - i })
      return o
    },
  ...
  var $e = Xe.extend({
    ...
    updateCellDates: function () {
      for (
        ...
        t.isHiddenDay(e) ? r.push(i + 0.5) : (i++, r.push(i), n.push(e.clone())), e.add(1, 'days')
    ...
    renderFillRow: function (e, n) {
      ...
      return (
        (i = t(
          '<div class="fc-' + e.toLowerCase() + '-skeleton">' + '<table><tr/></table>' + '</div>'
        )),
        (r = i.find('tr')),
  ...
  $e.mixin({
    ...
    fgSegHtml: function (t, e) {
      ...
      return (
        ...
        !r.allDay &&
          t.isStart &&
          (u = '<span class="fc-time">' + z(this.getEventTimeText(r)) + '</span>'),
      ...
      limitRow: function (e, n) {
        ...
        if (n && S.segLevels.length > n) {
          for (
            ...
            if (c) {
              for (
                f = o[n - 1][u.leftCol], g = f.attr('rowspan') || 1, p = [], m = 0;
                h.length > m;
                m++
              )
  ...
  var Ue = Xe.extend({
      ...
      for (
        ...
        (t = this.start.clone().time(a)),
          ...
          (i =
            ...
            r.axisStyleAttr() +
            '>' +
            (l && n ? '' : '<span>' + z(t.format(this.axisFormat)) + '</span>') +
            '</td>'),
          (o +=
            '<tr ' +
            (n ? 'class="fc-minor"' : '') +
    ...
    rangeToSegs: function (t) {
      var e,
        ...
        o = []
      for (
        t = { start: t.start.clone().stripZone(), end: t.end.clone().stripZone() }, n = 0;
        s > n;
        n++
      )
  ...
  var qe = (De.View = K.extend({
    ...
    opt: function (e) {
      ...
      return (
        ...
        void 0 !== n
          ? n
          : ((n = this.calendar.options[e]), t.isPlainObject(n) && !r(e) ? w(n, this.type) : n)
      )
    },
    ...
    unselect: function (t) {
      this.isSelected &&
        ((this.isSelected = !1), this.destroySelection(), this.trigger('unselect', null, t))
    },
    destroySelection: function () {},
    documentMousedown: function (e) {
      var n
      ...
      computeRange: function (t) {
        ...
        return (
          /year|month/.test(e.intervalUnit) &&
            ...
            e.end.weekday() &&
              (e.end.add(1, 'week').startOf('week'), (e.end = this.skipHiddenDays(e.end, -1, !0)))),
          e
        )
      },
      render: function () {
      ...
      numberCellHtml: function (t) {
        ...
        return this.dayNumbersVisible
          ? ((e = this.dayGrid.getDayClasses(n)),
            ...
            '<td class="' + e.join(' ') + '" data-date="' + n.format() + '">' + n.date() + '</td>')
          : '<td/>'
      },
  ...
  var tn = (Ce.month = Je.extend({
    computeRange: function (t) {
      ...
      return (
        this.isFixedWeeks() &&
          ((e = Math.ceil(n.end.diff(n.start, 'weeks', !0))), n.end.add(6 - e, 'weeks')),
        n
      )
    },
    setGridHeight: function (t, e) {
  ...
  ;(Ce.agenda = qe.extend({
      ...
      ;(this.timeGrid = new Ue(this)),
        this.opt('allDaySlot')
          ? ((this.dayGrid = new $e(this)),
            (this.coordMap = new Ze([this.dayGrid.coordMap, this.timeGrid.coordMap])))
    ...
    render: function () {
      this.el.addClass('fc-agenda-view').html(this.renderHtml()),
        ...
        (this.bottomRuleEl = t('<hr class="' + this.widgetHeaderClass + '"/>').appendTo(
          this.timeGrid.el
        )),
        this.dayGrid &&
          ((this.dayGrid.el = this.el.find('.fc-day-grid')),
