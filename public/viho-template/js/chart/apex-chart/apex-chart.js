                  ...
                  tooltip: {
                    ...
                    custom: function (t) {
                      ...
                      if (void 0 === s.config.tooltip.x.formatter)
                        ...
                        (o = s.config.tooltip.x.formatter(n)), (l = s.config.tooltip.x.formatter(r))
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              'function' == typeof r &&
                (r = r({ seriesIndex: this.seriesIndex, value: t.value, w: e }))
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  (u &&
                    (f = this.dataLabelsCorrection(a, s, o, n, r, d, parseInt(c.style.fontSize))),
                  ...
                  if (
                    (x.attr({ class: 'apexcharts-datalabel', cx: a, cy: s }), c.dropShadow.enabled)
                  ) {
                    var b = c.dropShadow
                  ...
                  y: (a =
                    void 0 === this.series[g][f] || null === this.series[g][f]
                      ...
                      : l -
                        ...
                        2 *
                          (this.isReversed ? this.series[g][f] / this.yRatio[this.yaxisIndex] : 0)),
                  zeroH: l,
                },
    ...
    Y = (function () {
      function t(i) {
        ...
        ;(this.lineColorArr =
          ...
          (this.donutSize =
            (a.globals.radialSize * parseInt(a.config.plotOptions.pie.donut.size)) / 100),
          (this.sliceLabels = []),
        ...
        a(i, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                (s =
                  h.move(g, x) + h.line(f, x) + h.line(f, x + r) + h.line(g, x + r) + h.line(g, x)),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                1.05 *
                  (t = new p(this.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize))
                    .width *
                  i.length >
                  e.globals.gridWidth &&
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              for (
                ...
                for (
                  var $ =
                      a.globals.dataPoints > 1 ? a.globals.dataPoints - 1 : a.globals.dataPoints,
                    J = 0;
                  J < $;
                  J++
                ) {
                ...
                i.forEach(function (e) {
                  ...
                  var a = function () {
                    t.ctx._updateOptions(
                      {
                        chart: {
                          selection: { xaxis: { min: i.w.globals.minX, max: i.w.globals.maxX } },
                        },
                      },
                      !1,
                      !1
                ...
                if (t.config.grid.yaxis.lines.show)
                  for (
                    ...
                    s.add(v),
                      ...
                      this.animY &&
                        this.animateLine(v, { y1: f + 20, y2: x + 20 }, { y1: f, y2: x }),
                ...
                if (t.config.grid.yaxis.lines.show)
                  for (var M = 0, T = 0, I = t.globals.gridWidth, X = 0; X < o + 1; X++) {
                    ...
                    s.add(Y),
                      ...
                      this.animY &&
                        this.animateLine(Y, { y1: M + 20, y2: T + 20 }, { y1: M, y2: T }),
