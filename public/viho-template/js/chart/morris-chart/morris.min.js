    ...
    (t.Grid = (function (n) {
      ...
      return (
        ...
        (r.prototype._calc = function () {
          ...
          if (this.elementWidth !== n || this.elementHeight !== e || this.dirty) {
            ;(this.elementWidth = n),
              ...
              this.options.axes &&
                ((t = Math.max(
                  this.measureText(this.yAxisFormat(this.ymin), this.options.gridTextSize).width,
                  this.measureText(this.yAxisFormat(this.ymax), this.options.gridTextSize).width
                )),
                (this.left += t),
        ...
        (r.prototype.redraw = function () {
          this.r.clear(), this._calc(), this.drawGrid(), this.drawGoals(), this.drawEvents()
        ...
        (r.prototype.drawGoals = function () {
          ...
          for (t = n = 0, r = i.length; n < r; t = ++n)
            (e = i[t]),
              s.push(
                this.r
                  .path('M' + this.left + ',' + this.transY(e) + 'H' + (this.left + this.width))
                  .attr(
                    'stroke',
                    this.options.goalLineColors[t % this.options.goalLineColors.length]
                  )
            ...
            (e = i[t]),
              s.push(
                this.r
                  ...
                  .attr(
                    'stroke',
                    this.options.eventLineColors[t % this.options.eventLineColors.length]
                  )
        ...
        (r.prototype.drawGrid = function () {
          ...
          for (n = s = e, o = this.yInterval; e <= t ? s <= t : s >= t; n = s += o)
            (r = parseFloat(n.toFixed(this.precision))),
              ...
              this.options.axes &&
                this.r
                  .text(this.left - this.options.padding / 2, i, this.yAxisFormat(r))
              ...
              this.options.grid
                ? u.push(
                    this.r
                      .path('M' + this.left + ',' + i + 'H' + (this.left + this.width))
        ...
        : ((n = e.match(/^(\d+) Q(\d)$/)),
          ...
          n
            ...
            ? a[6]
              ? ((o = 0),
                a[6] !== 'Z' &&
                  ((o = parseInt(a[8], 10) * 60 + parseInt(a[9], 10)), a[7] === '+' && (o = 0 - o)),
                Date.UTC(
                  parseInt(a[1], 10),
                  parseInt(a[2], 10) - 1,
                  parseInt(a[3], 10),
    ...
    (t.Line = (function (e) {
      ...
      return (
        ...
        (n.prototype.onHoverOut = function () {
          if (this.options.hideHover === 'auto') return this.displayHoverForIndex(null)
        }),
          ...
          ;(o = this.bottom + this.options.gridTextSize * 1.25),
            ...
            (e = function (e, t) {
              ...
              return (
                ...
                (r = n.getBBox()),
                (i == null || i >= r.x + r.width) && r.x >= 0 && r.x + r.width < l.el.width()
      ...
      return (
            ...
            (t = this.paths[e]),
              t !== null &&
                ((t +=
                  ...
                  this.bottom +
                  'Z'),
                this.r.path(t).attr('fill', this.fillForSeries(e)).attr('stroke-width', 0))
        ...
        (n.prototype.fillForSeries = function (e) {
          ...
          return (
            ...
            Raphael.hsl(t.h, Math.min(255, t.s * 0.75), Math.min(255, t.l * 1.25))
          )
        }),
        n
      )
    ...
    (t.Bar = (function (n) {
      ...
      return (
        ...
        (r.prototype.drawXAxis = function () {
          ...
          ;(o = this.bottom + this.options.gridTextSize * 1.25), (r = null), (f = [])
          for (e = u = 0, a = this.data.length; 0 <= a ? u < a : u > a; e = 0 <= a ? ++u : --u)
            (i = this.data[this.data.length - 1 - e]),
              ...
              this.options.verticalLabels &&
                ((s = Math.round(t.getBBox().width / 3)), t.transform('t0,' + s + 'r90')),
              (n = t.getBBox()),
              (r == null || r >= n.x + n.width) && n.x >= 0 && n.x + n.width < this.el.width()
                      ...
                      for (c = u = 0, g = y.length; u < g; c = ++u) {
                        ...
                        if (v !== null) {
                          m
                            ...
                            : ((d = v), (t = this.bottom)),
                            (s = this.left + r * n + o),
                            this.options.stacked || (s += c * (e + this.options.barGap)),
                            (h = t - d),
                            this.options.stacked && (d -= i),
                            (l = this.options.stacked ? 'sharp' : this.options.barShape)
                          switch (l) {
                            case 'sharp':
                              this.r
                                .rect(s, d, e, h)
        ...
        (r.prototype.onHoverMove = function (e, t) {
          var n, r
          return (
            (n = this.hitTest(e, t)), (r = this.hover).update.apply(r, this.hoverContentForRow(n))
          )
        }),
        ...
        (r.prototype.hoverContentForRow = function (e) {
          ...
          return (i = this.left + ((e + 0.5) * this.width) / this.data.length), [t, i]
        }),
        r
      )
    })(t.Grid)),
      ...
      return (
        ...
        (n.prototype.redraw = function () {
          ...
          for (v = 0, y = E.length; v < y; v++)
            (i = E[v]),
              ...
              (o = f),
              (s += 1)
          ;(this.text1 = this.r.text(n, r - 10, '').attr({ 'font-size': 15, 'font-weight': 800 })),
        ...
        (n.prototype.select = function (e) {
          ...
          return (
            ...
            n.select(),
            this.setLabels(n.data.label, this.options.formatter(n.data.value, n.data))
          )
        }),
