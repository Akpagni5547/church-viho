      ...
      /***/ function (module, exports, __webpack_require__) {
	    ...
	    \*/
          ...
          var loaded,
            ...
            concat = 'concat',
            supportsTouch =
              'ontouchstart' in g.win || (g.win.DocumentTouch && g.doc instanceof DocumentTouch), //taken from Modernizr touch test
            E = '',
            S = ' ',
            Str = String,
            split = 'split',
	    ...
	    \*/
          ...
          var getOffset = function (elem) {
            var box = elem.getBoundingClientRect(),
              ...
              left =
                box.left + (g.win.pageXOffset || docElem.scrollLeft || body.scrollLeft) - clientLeft
            return {
              y: top,
              x: left,
            }
          ...
          paperproto.print = function (
            ...
            if (font) {
              ...
              var bb = font.face.bbox[split](separator),
                ...
                shifty = 0,
                height =
                  +bb[1] + (origin == 'baseline' ? lineHeight + +font.face.descent : lineHeight / 2)
