  ...
  ;(window.PR_SHOULD_USE_CONTINUATION = !0),
    (function () {
            ...
            if (/\\[bdsw]/i.test(a)) s.push(a)
              ...
              o > r + 2 && '-' === n[r + 1] ? ((l = t(n[r + 2])), (r += 2)) : (l = a),
                ...
                65 > l ||
                  ...
                  97 > l || a > 122 || e.push([-33 & Math.max(97, a), -33 & Math.min(l, 122)]))
            }
          }
          for (
            e.sort(function (e, t) {
        ...
        function r(e) {
          ...
          for (h = l = 0; r > l; ++l)
            (c = t[l]),
              '(' === c
                ? (++h, a[h] || (t[l] = '(?:'))
                : '\\' === c.charAt(0) && (c = +c.substring(1)) && h >= c && (t[l] = '\\' + a[c])
      ...
      function s(i, r) {
        function s(e) {
          for (
            var t = e.e, i = [t, 'pln'], c = 0, u = e.a.match(o) || [], d = {}, p = 0, f = u.length;
            f > p;
            ++p
          ) {
            var m,
      ...
      function l(e, t) {
        for (var i = t.length; --i >= 0; ) {
          var n = t[i]
          w.hasOwnProperty(n)
            ? u.console && console.warn('cannot override language handler %s', n)
            : (w[n] = e)
        }
      }
      function h(e, t) {
        return (
          (e && w.hasOwnProperty(e)) || (e = /^\s*</.test(t) ? 'default-markup' : 'default-code'),
          w[e]
        )
      }
      function c(e) {
      ...
      l(C, ['default-code']),
        ...
        l(o({ keywords: g, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: L }), [
          'cs',
        ]),
        l(o({ keywords: m, cStyleComments: !0 }), ['java']),
        l(o({ keywords: d, hashComments: !0, multiLineStrings: !0 }), ['bash', 'bsh', 'csh', 'sh']),
        l(o({ keywords: y, hashComments: !0, multiLineStrings: !0, tripleQuotedStrings: !0 }), [
          'cv',
          'py',
          'python',
        ]),
        ...
        l(o({ keywords: v, hashComments: !0, multiLineStrings: !0, regexLiterals: !0 }), [
          'rb',
          'ruby',
        ]),
        l(o({ keywords: p, cStyleComments: !0, regexLiterals: !0 }), ['javascript', 'js']),
        l(
          o({
            keywords:
        ...
        l(o({ keywords: b, cStyleComments: !0, multilineStrings: !0 }), ['rc', 'rs', 'rust']),
        l(s([], [['str', /^[\S\s]+/]]), ['regex'])
      var S = (u.PR = {
        createSimpleLexer: s,
              ...
              if (((d = s.className), (h !== w || v.test(d)) && !b.test(d))) {
                ...
                if (!p) {
                  if (((s.className += ' prettyprinted'), (p = h.lang), !p)) {
                    var O,
                      p = d.match(y)
                    !p && (O = r(s)) && x.test(O.tagName) && (p = O.className.match(y)),
                      p && (p = p[1])
                  }
                    ...
                    var S = s.currentStyle,
                      ...
                      S =
                        (S = S
                          ...
                          ? _.getComputedStyle(s, e).getPropertyValue('white-space')
