    ...
    return (
      c.each(function (c, d) {
        function e() {
          ...
          ;(C = a('<div class="ge-addRowGroup btn-group" />').appendTo(b)),
            a.each(E.new_row_layouts, function (b, c) {
              var d = a('<a class="btn-sm btn-grid btn-square btn-grid p-10" />')
        ...
        function j(b, c, d, e, f) {
          var g = a(
            '<a title="' + c + '" class="' + d + '"><span class="fa ' + e + '"></span></a>'
          ).appendTo(b)
          ...
          return (
            c.forEach(function (c) {
              var d = a('<a class="btn btn-sm btn-default" />')
                .html(c.label)
                .attr('title', c.title ? c.title : 'Toggle "' + c.label + '" styling')
        ...
        function m(a, b) {
          for (var c = n(a), d = 0; d < c.length; d++) if (c[d].colClass == b) return c[d].size
      ...
      deinit: function (a, b) {
        b.filter('.active').each(function () {
          ...
          a.summernote('destroy'),
            a.removeClass('active').removeAttr('id').removeAttr('style').removeAttr('spellcheck')
        })
      },
