    ...
    if (b != c)
      if (0 > b || b >= l) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b)
        ...
        f(a.oInstance).trigger('column-reorder.dt', [
          a,
          { from: b, to: c, mapping: n, drop: e, iFrom: b, iTo: c, aiInvertMapping: n },
        ])
      }
  }
  var i = function (a, b) {
    ...
    _fnMouseMove: function (a) {
      ...
      for (var b = !1, c = this.s.mouse.toIndex, e = 1, f = this.s.aoTargets.length; e < f; e++)
        if (
          ...
          this.s.aoTargets[e - 1].x + (this.s.aoTargets[e].x - this.s.aoTargets[e - 1].x) / 2
        ) {
      ...
      this.s.init.bRealtime &&
        ...
        (this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex, this.s.mouse.toIndex, !1),
      ...
      for (var b = 0, c = this.s.aoTargets[0].x, e = 0, g = a.length; e < g; e++)
        e != this.s.mouse.fromIndex && b++,
          a[e].bVisible &&
            ...
            ((c += f(a[e].nTh).outerWidth()), this.s.aoTargets.push({ x: c, to: b }))
      0 !== this.s.fixedRight &&
