...
;(function (c) {
  ...
  function r(b, a, c) {
    ...
    if (m[e]) {
      for (
        var b = b.cell(a, c).node(), c = m[e][0].parentNode.childNodes, a = [], f = 0, g = c.length;
        f < g;
        f++
      )
        a.push(c[f])
  ...
  c.extend(j.prototype, {
    ...
    _columnsVisiblity: function (b) {
      ...
      for (f = g.length; e < f; e++) {
        ...
        '-' === i[h] &&
          !d[h].control &&
          d[h].minWidth &&
          (n || 0 > a - d[h].minWidth ? ((n = !0), (i[h] = !1)) : (i[h] = !0), (a -= d[h].minWidth))
      }
      g = !1
      e = 0
    ...
    _detailsDisplay: function (b, a) {
      ...
      if (f && !1 !== f.type) {
        ...
        ;(!0 === g || !1 === g) &&
          c(e.table().node()).triggerHandler('responsive-display.dt', [e, b, g, a])
      }
    },
        ...
        c.each(d, function (a, d) {
          d.hidden &&
            (c(
              ...
              .append(c('<span class="dtr-data"/>').append(s(b, d.rowIndex, d.columnIndex)))
              .appendTo(e),
            (f = !0))
        })
        return f ? e : !1
