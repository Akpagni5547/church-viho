        ...
        t = (function () {
          ...
          return (
            ...
            (h.prototype._setValue = function (a, b) {
              ...
              if (!a)
                return (
                  ...
                  this._notifyEvent({ type: h.Event.CHANGE, date: !1, oldDate: c }),
                  void this._update()
                )
              if (
                ...
                this._options.keepInvalid
                  ? this._notifyEvent({ type: h.Event.CHANGE, date: a, oldDate: c })
                  : void 0 !== this.input &&
                    (this.input.val(
                      '' + (this.unset ? '' : this._dates[b].format(this.actualFormat))
                    ),
                    this.input.trigger('input')),
                  this._notifyEvent({ type: h.Event.ERROR, date: a, oldDate: c })
            }),
            ...
            (h.prototype._notifyEvent = function (a) {
              ;(a.type === h.Event.CHANGE && a.date && a.date.isSame(a.oldDate)) ||
                (!a.date && !a.oldDate) ||
            ...
            (h.prototype._showMode = function (a) {
              this.widget &&
                (a && (this.currentViewMode = Math.max(s, Math.min(3, this.currentViewMode + a))),
                this.widget
                  .find('.datepicker > div')
                  .hide()
            ...
            (h.prototype._keydown = function (a) {
              ...
              for (c in this._options.keyBinds)
                if (
                  ...
                  ((e = c.split(' ')), e.length === g.length && o[i] === e[e.length - 1])
                ) {
            ...
            (h.prototype._keyup = function (a) {
              ;(q[a.which] = 'r'),
                r[a.which] && ((r[a.which] = !1), a.stopPropagation(), a.preventDefault())
            }),
              ...
              return (
                (b =
                  void 0 === a || null === a
                    ...
                    : window.moment(a, this.parseFormats, this._options.useStrict)),
            ...
            (h.prototype.viewMode = function (a) {
              ...
              if (h.ViewModes.indexOf(a) === -1)
                throw new TypeError(
                  'viewMode() parameter must be one of (' + h.ViewModes.join(', ') + ') value'
                )
              ;(this._options.viewMode = a),
                (this.currentViewMode = Math.max(h.ViewModes.indexOf(a) - 1, h.MinViewModeNumber)),
                this._showMode()
            }),
            ...
            (h.prototype.viewDate = function (a) {
              ...
              if (!('string' == typeof a || window.moment.isMoment(a) || a instanceof Date))
            ...
            for (
              b.eq(0).find('span').attr('title', this._options.tooltips.prevDecade),
                ...
                this._options.maxDate &&
                  ...
                  b.eq(2).addClass('disabled'),
                f +=
                  '<span data-action="selectYear" class="year old">' + (d.year() - 1) + '</span>';
              !d.isAfter(e, 'y');
              ...
              (f +=
                ...
                '</span>'),
                d.add(1, 'y')
            ;(f += '<span data-action="selectYear" class="year old">' + d.year() + '</span>'),
              a.find('td').html(f)
          }),
