                    ...
                    '' === f && (f = j),
                      ...
                      setTimeout(
                        a.proxy(function () {
                          ...
                          a.length &&
                            ((this._data.core.focused = n.id), a.children('.jstree-anchor').focus())
                        }, this),
                        0
                      ),
                      d && d.call(this, n, m, o),
                  ...
                  .each(function () {
                    ...
                    if (i)
                      if (i.state.loaded) {
                        ...
                        for (
                          g[i.id] === b && i.id !== a.jstree.root && ((g[i.id] = !0), k.push(i.id)),
                            e = 0,
                            f = i.parents.length;
                          f > e;
                          e++
            ...
            .on('touchmove.vakata.jstree', function (a) {
              c &&
                ...
                (Math.abs(e - a.originalEvent.changedTouches[0].clientX) > 50 ||
                  Math.abs(f - a.originalEvent.changedTouches[0].clientY) > 50) &&
                clearTimeout(c)
            })
          ...
          _show_submenu: function (c) {
            if (((c = a(c)), c.length && c.children('ul').length)) {
              ...
              b
                ...
                : c[f + h > j && e > j - f ? 'addClass' : 'removeClass']('vakata-context-end'),
