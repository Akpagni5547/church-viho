...
$(function () {
  ...
  $('.element-type label').click(function () {
    ...
    if ($(this).children('input').attr('value') == 'a') {
      $('#result').empty()
      var btnCode =
        '<a href="javascript:void(0)"' + ' ' + 'class="' + currentClass + '">' + btnText + '</a>'
      $('#result a').remove()
      ...
      $('#result').empty()
      var btnCode =
        '<button type="button"' + ' ' + 'class="' + currentClass + '">' + btnText + '</button>'
      ...
      $('#result').empty()
      var btnCode =
        '<input type="button"' + ' ' + 'class="' + currentClass + '" value="' + btnText + '">'
      $('#result button').remove()
      $('#result').append(btnCode)
      ...
      $('#result').empty()
      var btnCode =
        '<input type="submit"' + ' ' + 'class="' + currentClass + '" value="' + btnText + '">'
      $('#result button').remove()
      $('#result').append(btnCode)
      var btnHTML = $('#result').html()
      $('.button-html').html(filterHTML(btnHTML))
