...
;(function (e, t) {
      ...
      if ((c && l[c] && (i || l[c].data)) || !a || r !== t)
        return (
          ...
          ('object' == typeof n || 'function' == typeof n) &&
            (i ? (l[c] = ut.extend(l[c], n)) : (l[c].data = ut.extend(l[c].data, n))),
          (s = l[c]),
        ...
        n.style &&
          ...
          t
            ? (r[i] || 'none' !== n.style.display || (n.style.display = ''),
              '' === n.style.display && S(n) && (r[i] = ut._data(n, 'olddisplay', k(n.nodeName))))
      ...
      'margin' === n && (o += ut.css(e, n + Sn[s], !0, i)),
        r
          ? ('content' === n && (o -= ut.css(e, 'padding' + Sn[s], !0, i)),
            'margin' !== n && (o -= ut.css(e, 'border' + Sn[s] + 'Width', !0, i)))
          : ((o += ut.css(e, 'padding' + Sn[s], !0, i)),
            'padding' !== n && (o += ut.css(e, 'border' + Sn[s] + 'Width', !0, i)))
    return o
  }
    ...
    if ((o = v.length)) {
      ...
      for (r = 0; o > r; r++)
        (i = v[r]),
          ...
          i in u ||
            ((u[i] = f.start),
            m && ((f.end = f.start), (f.start = 'width' === i || 'height' === i ? 1 : 0)))
    }
  }
  ...
  ;(ut.fn = ut.prototype =
        ...
        if ('string' == typeof e) {
          ...
          if (i[1]) {
            if (
              ...
              ut.merge(this, ut.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : $, !0)),
    ...
    ut.extend({
      ...
      parseHTML: function (e, t, n) {
        ...
        return r
          ? [t.createElement(r[1])]
          : ((r = ut.buildFragment([e], t, i)), i && ut(i).remove(), ut.merge([], r.childNodes))
      },
      parseJSON: function (n) {
        return e.JSON && e.JSON.parse
          ...
          ? n
          : 'string' == typeof n &&
            ((n = ut.trim(n)), n && pt.test(n.replace(vt, '@').replace(mt, ']').replace(dt, '')))
          ? Function('return ' + n)()
      ...
      makeArray: function (e, t) {
        var r = t || []
        return (
          null != e && (n(Object(e)) ? ut.merge(r, 'string' == typeof e ? [e] : e) : tt.call(r, e)),
          r
        )
      },
    ...
    (ut.ready.promise = function (t) {
      if (!V)
        if (((V = ut.Deferred()), 'complete' === $.readyState)) setTimeout(ut.ready)
          ...
          $.addEventListener('DOMContentLoaded', wt, !1), e.addEventListener('load', ut.ready, !1)
        else {
        ...
        if (o > 1)
          for (t = Array(o), n = Array(o), r = Array(o); o > i; i++)
            s[i] && ut.isFunction(s[i].promise)
              ? s[i].promise().done(f(i, r, s)).fail(a.reject).progress(f(i, n, t))
              : --u
    ...
    ut.extend({
      queue: function (e, n, r) {
        ...
        return e
          ? ((n = (n || 'fx') + 'queue'),
            (i = ut._data(e, n)),
            r && (!i || ut.isArray(r) ? (i = ut._data(e, n, ut.makeArray(r))) : i.push(r)),
            i || [])
          : t
      },
  ...
  ut.fn.extend({
      ...
      if (a)
        for (t = (e || '').match(ft) || []; u > o; o++)
          if (
            ((n = this[o]),
            (r =
              1 === n.nodeType && (n.className ? (' ' + n.className + ' ').replace(Ct, ' ') : ' ')))
          ) {
    ...
    toggleClass: function (e, t) {
      ...
      return ut.isFunction(e)
        ...
        : this.each(function () {
            if ('string' === n)
              for (var i, s = 0, o = ut(this), u = t, a = e.match(ft) || []; (i = a[s++]); )
                (u = r ? u : !o.hasClass(i)), o[u ? 'addClass' : 'removeClass'](i)
            else
              ('undefined' === n || 'boolean' === n) &&
                (this.className && ut._data(this, '__className__', this.className),
                (this.className =
                  this.className || e === !1 ? '' : ut._data(this, '__className__') || ''))
          })
    },
    hasClass: function (e) {
      ...
      if (s)
        return (
          ...
          n && 'get' in n && (r = n.get(s, 'value')) !== t
            ? r
            : ((r = s.value), 'string' == typeof r ? r.replace(kt, '') : null == r ? '' : r)
        )
    },
  }),
    ut.extend({
          ...
          get: function (e) {
            for (
              ...
              if (
                ...
                !(
                  (!n.selected && a !== i) ||
                  (ut.support.optDisabled ? n.disabled : null !== n.getAttribute('disabled')) ||
                  (n.parentNode.disabled && ut.nodeName(n.parentNode, 'optgroup'))
                ))
              ) {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (m && (a = m.events)) {
        for (t = (t || '').match(ft) || [''], f = t.length; f--; )
          if (
            ((u = Ft.exec(t[f]) || []), (p = v = u[1]), (d = (u[2] || '').split('.').sort()), p)
          ) {
            for (
        ...
        for (
          ...
          for (
            ...
            (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
              ((e.handleObj = o),
              (e.data = o.data),
              (i = ((ut.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, a)),
      ...
      (ut.event.special.submit = {
        ...
        postDispatch: function (e) {
          e._submit_bubble &&
            ...
            this.parentNode && !e.isTrigger && ut.event.simulate('submit', this.parentNode, e, !0))
        },
        teardown: function () {
      ...
      function w(e, t, n, r) {
        ...
        if (!r && 1 === f.length) {
          ...
          for (
            ...
            if (
              (a = T.find[u]) &&
              (r = a(o.matches[0].replace(wt, Et), (pt.test(s[0].type) && t.parentNode) || t))
            ) {
                ...
                (F = _.compareDocumentPosition
                  ...
                  : function (e, t) {
                      ...
                      if (e.sourceIndex && t.sourceIndex)
                        return (~t.sourceIndex || J) - ((j(q, e) && ~e.sourceIndex) || J)
  ...
  ut.fn.extend({
    ...
    ut.extend({
      ...
      dir: function (e, n, r) {
        for (
          var i = [], s = e[n];
          s && 9 !== s.nodeType && (r === t || 1 !== s.nodeType || !ut(s).is(r));
  ...
  ;(sn.optgroup = sn.option),
      ...
      text: function (e) {
        return ut.access(
          ...
          function (e) {
            return e === t
              ? ut.text(this)
              : this.empty().append(((this[0] && this[0].ownerDocument) || $).createTextNode(e))
          },
          null,
          e,
          arguments.length
        ...
        return (
          ...
          this.domManip([e], !0, function (e) {
            ...
            ;((n && 1 === this.nodeType) || 11 === this.nodeType) &&
              (ut(this).remove(), t ? t.parentNode.insertBefore(e, t) : n.appendChild(e))
          })
        )
      },
      detach: function (e) {
    ...
    ut.extend({
      clone: function (e, t, n) {
        ...
        if (
          (ut.support.html5Clone || ut.isXMLDoc(e) || !Vt.test('<' + e.nodeName + '>')
            ? (u = e.cloneNode(!0))
            : ((un.innerHTML = e.outerHTML), un.removeChild((u = un.firstChild))),
          !(
        ...
        return (
          (r = b(u, 'script')), r.length > 0 && m(r, !a && b(e, 'script')), (r = i = s = null), u
        )
      },
      ...
      cleanData: function (e, n) {
        for (
          ...
          if ((n || ut.acceptData(s)) && ((i = s[a]), (r = i && f[i]))) {
            ...
            f[i] &&
              (delete f[i],
              l ? delete s[a] : s.removeAttribute !== t ? s.removeAttribute(a) : (s[a] = null),
              Y.push(i))
          }
      },
    })
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ...
            'string' === o &&
              (s = yn.exec(r)) &&
              ((r = (s[1] + 1) * s[2] + parseFloat(ut.css(e, n))), (o = 'number')),
            !(
              null == r ||
              ('number' === o && isNaN(r)) ||
          ...
          return T(
            ...
            r
              ? N(
                  ...
                  n,
                  r,
                  ut.support.boxSizing && 'border-box' === ut.css(e, 'boxSizing', !1, i),
                  i
                )
              : 0
          )
    ...
    ut.extend({
      ...
      ajax: function (e, n) {
          ...
          2 !== w &&
            ...
            (e >= 200 && 300 > e) || 304 === e
              ? (h.ifModified &&
                ...
                304 === e
                  ? ((f = !0), (x = 'notmodified'))
                  : ((f = P(h, b)), (x = f.state), (c = f.data), (y = f.error), (f = !y)))
        ...
        ;(l = h.global),
          ...
          (s = h.url),
          h.hasContent ||
            (h.data && ((s = h.url += (_n.test(s) ? '&' : '?') + h.data), delete h.data),
            h.cache === !1 &&
              (h.url = Pn.test(s)
                ? s.replace(Pn, '$1_=' + Mn++)
                : s + (_n.test(s) ? '&' : '?') + '_=' + Mn++)),
          h.ifModified &&
            (ut.lastModified[s] && S.setRequestHeader('If-Modified-Since', ut.lastModified[s]),
          ...
          S.setRequestHeader(
            ...
            h.dataTypes[0] && h.accepts[h.dataTypes[0]]
              ? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + zn + '; q=0.01' : '')
              : h.accepts['*']
          )
  ...
  ut.ajaxSetup({
    ...
    ut.ajaxPrefilter('json jsonp', function (n, r, i) {
      ...
      return a || 'jsonp' === n.dataTypes[0]
        ? ((s = n.jsonpCallback =
            ut.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback),
          a
            ? (n[a] = n[a].replace(Vn, '$1' + s))
            : n.jsonp !== !1 && (n.url += (_n.test(n.url) ? '&' : '?') + n.jsonp + '=' + s),
                ...
                (r = function (e, i) {
                  ...
                  try {
                    if (r && (i || 4 === a.readyState))
                      if (((r = t), o && ((a.onreadystatechange = ut.noop), Qn && delete $n[o]), i))
        ...
        return (
          (this.pos = t =
            this.options.duration
              ? ut.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration)
              : e),
    ...
    (U.propHooks = {
      _default: {
        ...
        set: function (e) {
          ut.fx.step[e.prop]
            ? ut.fx.step[e.prop](e)
            : e.elem.style && (null != e.elem.style[ut.cssProps[e.prop]] || ut.cssHooks[e.prop])
            ...
            function (e, i, s) {
              ...
              return s === t
                ? o
                  ...
                  : e[i]
                : (o
                    ? o.scrollTo(r ? ut(o).scrollLeft() : s, r ? s : ut(o).scrollTop())
                    : (e[i] = s),
                  t)
            },
            e,
  ...
  function () {
    ...
    ;(x.template = function (e, t, n) {
      ...
      var i = new RegExp(
          [(n.escape || P).source, (n.interpolate || P).source, (n.evaluate || P).source].join(
            '|'
          ) + '|$',
          'g'
        ),
  ...
  function () {
    ...
    s.extend(f.prototype, a, {
      ...
      url: function () {
        ...
        return this.isNew()
          ? e
          : e + (e.charAt(e.length - 1) == '/' ? '' : '/') + encodeURIComponent(this.id)
      },
      parse: function (e, t) {
        return e
      },
    ...
    s.extend(l.prototype, a, {
      ...
      sort: function (e) {
        ...
        return (
          this.comparator.length == 1 ? (this.models = this.sortBy(t)) : this.models.sort(t),
      ...
      _onModelEvent: function (e, t, n, r) {
        ...
        e == 'destroy' && this.remove(t, r),
          t &&
            ...
            (delete this._byId[t.previous(t.idAttribute)], (this._byId[t.id] = t)),
        ...
        navigate: function (e, t) {
          ...
          this._hasPushState
            ? (n.indexOf(this.options.root) != 0 && (n = this.options.root + n),
              (this.fragment = n),
              window.history[t.replace ? 'replaceState' : 'pushState']({}, document.title, n))
            : this._wantsHashChange
            ? ((this.fragment = n),
    ...
    ;(i.sync = function (e, t, n) {
      ...
      return (
        ...
        !n.data &&
          t &&
          (e == 'create' || e == 'update') &&
          ((u.contentType = 'application/json'), (u.data = JSON.stringify(t.toJSON()))),
        i.emulateJSON &&
  ...
  define('text', ['module'], function (e) {
    ...
    if (
      c.env === 'node' ||
      (!c.env && typeof process != 'undefined' && process.versions && !!process.versions.node)
    )
...
;+(function (e) {
              ...
              return (
                (s &&
                  s.length && [
                    [
                      s[t]().top +
                        (!e.isWindow(n.$scrollElement.get(0)) && n.$scrollElement.scrollTop()),
                      i,
                    ],
                  ]) ||
                null
  ...
  define(
    ...
    ['jquery', 'underscore', 'backbone', 'views/snippet', 'views/temp-snippet', 'helper/pubsub'],
          ...
          e('.popover').remove(),
            ...
            this.model.get('title') !== 'Form Name' &&
              e('body').on('mousemove', function (e) {
                if (Math.abs(t.pageX - e.pageX) > 10 || Math.abs(t.pageY - e.pageY) > 10)
