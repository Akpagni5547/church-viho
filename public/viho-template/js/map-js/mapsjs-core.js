;(function () {
  ...
  function Va(a, b, c, d) {
    ...
    f &&
      (e = e ? e.substr(1).replace('.' + Sa[0] + '.', '#') : '~' + (sa(a) ? eb(a) + '()' : Ya(a)))
    return e
  }
  function db(a, b) {
    var c = []
  ...
  function jb(a, b) {
    ...
    !ib &&
      c &&
      c.warn &&
      ((d = Va(a) + ' is deprecated and will be removed soon. '), b && (d += b), c.warn(d))
  }
  function C(a, b, c) {
  ...
  var Vb = { undefined: 'GL', GL: 'GL', OL: 'OL', SL: 'SL', SB: 'SB', WE: 'WE', WG: 'WG' }
  ...
  function dc(a, b) {
    var c, d, e
    if ((e = a.S()))
      (c = a.l(!0)) && (d = a.f()) && (e = e.wb(fc([a.g(0), a.g(d - 1)], !0), !0)),
        ...
        (a =
          ...
          xb(
            lb(
              1,
              tb(
                ub(wb((b - c) / 2), 2) + yb(b) * yb(c) * ub(wb((this.lng * Ib - a.lng * Ib) / 2), 2)
              )
            )
          )))
    return a
  ...
  gc.prototype.Gf = function (a, b, c) {
    ...
    if (0 === (a + 90) % 180)
      return (
        (d = this.lng + (b / (6371000.79 * Gb * yb(this.lat * Ib))) * (270 === a ? -360 : 360)),
  ...
  function Tc() {
    if (fa.Promise && fa.Promise.resolve) {
      ...
      Sc = function () {
        var a = Wc
        !sa(fa.setImmediate) ||
        (fa.Window && fa.Window.prototype && fa.Window.prototype.setImmediate == fa.setImmediate)
          ? (Pc || (Pc = Qc()), Pc(a))
          : fa.setImmediate(a)
      }
  }
      ...
      if (a.b) {
        ...
        if (c.a) {
          ...
          e &&
            (c.G == Yc && 1 == d
              ? kd(c, b)
              : (f ? ((d = f), d.next == c.c && (c.c = d), (d.next = d.next.next)) : ld(c),
                md(c, e, bd, b)))
        }
        a.b = null
      } else $c(a, bd, b)
  ...
  Dd.prototype.remove = function (a, b, c, d) {
    ...
    b = Ed(e, b, c, d)
    return -1 < b
      ? (Cd(e[b]), Ga.splice.call(e, b, 1), 0 == e.length && (delete this.a[a], this.b--), !0)
      : !1
  }
  function Fd(a, b) {
    var c = b.type
  ...
  function ie(a, b, c, d, e) {
    ...
    if ((a = de(a)))
      if (
        ((b = a.a[b.toString()]), (a = -1), b && (a = Ed(b, c, !!d, e)), (c = -1 < a ? b[a] : null))
      )
        return je(c)
    return !1
  }
  ...
  function Ke(a, b) {
    var c = b || '',
      d
    Je ? ((d = new Je()), d.append(a), (c = d.getBlob(c))) : (c = new Blob([a], { type: c }))
    return c
  }
  function Le() {}
  ...
  K.prototype.setVisibility = function (a) {
    var b = this.T
    ;(a = !!a) ^ b &&
      ((this.T = a), this.invalidate(Me.VISUAL), this.dispatchEvent(new Ne(this.yb.Hh, a, b)))
    return this
  }
  ...
  G.prototype.pa = function (a) {
    return (
      this === a ||
      (!!a && this.ka === a.ka && this.ga === a.ga && this.ja === a.ja && this.ha === a.ha)
    )
  }
  ...
  G.prototype.xc = function (a, b) {
    ...
    var c = this.ga <= this.ha,
      ...
      f = a.ga < this.ha
    return (
      this.ja <= a.ka && a.ja <= this.ka && ((!c && (!d || e || f)) || (!d && (e || f)) || (e && f))
    )
  }
  ...
  function fc(a, b) {
    ...
    var c = 1,
      ...
      e,
      f = null
    if (0 < d) for (e = a[0], f = Xe(e, e, b); c < d; c++) (e = a[c]), f.b(e.lat, e.lng, b, f)
    return f
  }
  G.coverPoints = fc
  function Ye(a, b) {
    ...
    var c = 3,
      d = a.length,
      e
    if (0 < d) for (e = new G(a[0], a[1], a[0], a[1]); c < d; c += 3) e.b(a[c], a[c + 1], b, e)
    return e
  }
  ...
  function Ze(a, b) {
    ...
    var c = 1,
      d = a.length,
      e
    if (0 < d) for (e = new G(a[0].ka, a[0].ga, a[0].ja, a[0].ha); c < d; c++) e.wb(a[c], b, e)
    return e
  }
  G.coverRects = Ze
  ...
  function bf(a, b) {
    for (var c, d, e, f, g, h, k, l = 0, m, n, q = 4, t; q--; ) {
      ...
      for (m = (d = a[q]).length; m--; ) {
        e = d[m]
        if ((f = e.Y)) for (n = f.length; n--; ) ((k = f[n][q]) > h) - c && (h = k)
        for (n = 4; n--; ) if ((f = e[n])) c ? f[t] < h && g.push(f) : f[t] > h && g.push(f)
      }
      l += g.length
      b[q] = h
      a[q] = g
  ...
  function cf(a, b) {
    ...
    if (b) {
      if (((d = b), d !== c))
        for (c = d; (d = d.a); ) if (d.Y || 3 > !d[0] + !d[1] + !d[2] + !d[3]) c = d
    } else
  ...
  function gf(a, b, c, d, e, f, g) {
    ...
    f >= m &&
      (e <= t && b[1] && gf(a, b[1], c, d, e, f, g), g >= t && b[3] && gf(a, b[3], c, d, e, f, g))
    d <= m &&
      (e <= t && b[0] && gf(a, b[0], c, d, e, f, g), g >= t && b[2] && gf(a, b[2], c, d, e, f, g))
  }
    ...
    if (!this.a) {
      ...
      if ((d = !this.f)) {
        ...
        !(e = a.b) &&
          ...
          ((e = [d]), (e = bf([e, e, e, e], [d[6], d[7], d[4], d[5]])), (a.b = e))
        d = a = e
      }
  ...
  function kf(a, b, c, d, e, f) {
    f
      ? ((f = new ff(null, e, -b, c + 360, -d)), a.g.push(f), a.b && a.b.a(b, c, d, e, !0, a.b))
      : ((f = a.i), (f = ef(f, f.l, c, -b, e, -d, f.j)), a.f && a.f.a(b, c, d, e, !0, a.f))
    ++a.c
    a.a = null
    return f
  }
  ...
  function of(a, b) {
    var c = a.i,
      ...
      h
    b.g()
      ? ((h = c.bb(-180, f, e, g)), nf(h, c.bb(d, f, 180, g)), nf(h, lf(a, f, e, g, d + 360)))
    ...
    if (!(a = this.a)) {
      ...
      if (3 <= b)
        for (d = e = a[0], f = g = a[1], k = new G(d, f, e, g); c < b; c += 3) {
          ...
          e = a[c]
          g = a[c + 1]
          if ((f > g && 180 < g - f) || (f < g && -180 > f - g) || (g < f && 180 > rb(g - f)))
            (h = f), (f = g), (g = h)
          d < e && ((h = d), (d = e), (e = h))
        ...
        if (((m = l[g]), (k = m.length))) {
          ...
          for (c = 0; c < k; c += 2)
            (h = m[c]),
              ...
              c &&
                ac(n, q) &&
                (e.push(d), (d = []), (q += 0 > q ? 360 : -360), d.push(m[c - 2], q, h, n))
          e.push(d)
        }
      l = e
    }
  ...
  function Ff(a) {
    ...
    if (a) {
      ...
      for (c in a)
        c in this &&
          ((d = a[c]), d !== this[c] && ('fillColor' === c || 0 < (d = +d)) && (this[c] = d))
  ...
  Ff.prototype.fd = !0
  Ca(Ff.prototype, { fillColor: 'rgba(255,255,255,.75)', width: 1.2, length: 1.6, frequency: 5 })
    ...
    if (Zf(b, d, g, a, f, !0).length) {
      if (!c.s().j(e)) {
        ...
        for (d = c.length; d--; ) {
            ...
            for (m = b; m.next; m = m.next)
              if (!m.bb)
                for (n = g; n.next; n = n.next)
                  !n.bb &&
                    ((t = cg(m.next)), (T = cg(n.next)), (q = dg(m, t, n, T, a))) &&
                    ((q = a.Kh),
                    (J = a.Zf),
                    (u = a.Hi),
                    (y = a.Ii),
          ...
          if (g) for (b = ig(g), f.push(b); g.ef; ) (g = g.ef), (b = ig(g)), f.push(b)
        }
        b = f
      }
  ...
  function jg(a, b, c) {
    ...
    for (m = c.length; d < m; d++)
      (k = c[d].x),
        ...
        k > g ? (g = k) : k < e && (e = k),
        l > h ? (h = l) : l < f && (f = l)
    return e <= a && a <= g && f <= b && b <= h ? 1 === fg({ x: a, y: b }, c.concat(c[0])) : !1
  }
  function ig(a) {
    var b = [],
      c,
    ...
    do {
      ...
      if (!c || 0.01 < tb(ub(c.x - e, 2) + ub(c.y - f, 2))) (c = new M(e, f)), b.push(c)
      d = d.next
    } while (d && d !== a)
    return b
  }
  ...
  function Yf(a, b) {
    ...
    for (h = 0; h < g; h += 3)
      (k = d[h]),
        (l = d[h + 1]),
        m || 180 != rb(l) || (f.push(k), f.push(l), f.push(k), f.push(-l), (m = !0)),
        f.push(k),
        f.push(l)
    d = f
  ...
  function ng(a) {
    var b = a.o,
      ...
      e = 0,
      f = new F()
    if (90 === rb(c)) for (c = b.Gf(0, d, !0).lat; 360 > e; e += 120) f.o(c, e - 180, A)
  ...
  function ug(a) {
    ...
    if (b !== Eg) {
      ...
      if ('EMPTY' === c)
        a.next(),
          (d = b[1]) ? (f = new d([])) : b !== Gg && ((f = new F([])), b === Fg && (f = new E(f)))
      else if ('(' === c) {
        f = b[0]
        b = b[1]
        var g, h
  ...
  Vg.prototype.add = function (a, b, c) {
    ...
    d
      ? e
        ...
        : Xg(this, d, !0)
      : e && (this.Y[a] = Yg(this, { id: a, data: b, size: c, xb: null, Xb: null }, this.b))
    Zg(this)
    return e
  }
  ...
  M.prototype.a = function (a, b) {
    ...
    if (c || d)
      (e = ((this.x - a.x) * c + (this.y - a.y) * d) / (c * c + d * d)),
        0 >= e ? (f = a) : 1 <= e ? (f = b) : (f = new M(a.x + e * c, a.y + e * d))
    return f
  }
  ...
  function wh(a, b, c, d, e) {
    ...
    e = []
    var g
    for (g = 0; g < d; g++) for (f = a[g], b = f.data.length; b--; ) e.push(f.data[b])
    ...
    se: function (a) {
      ...
      if ((d = this.Zg[a]))
        (b = this.Hf),
          ...
          (b = c),
          b.f[a] || ((b.f[a] = d), Ih(b, '1', [a, sa(d) ? d + '' : d]).then(sc, z(b.l, b, a)))
  ...
  function Uh(a, b) {
    ...
    if (a !== Vh.NONE) {
      ...
      f === Vh.RECT &&
        3 < c &&
        ((l = [l[0], l[1], l[2], l[1], l[2], l[3], l[0], l[3]]), (f = Vh.POLYGON))
  ...
  Wh.prototype.$b = function (a) {
    ...
    if (b !== a) {
      if (!B(a, this.pg))
        throw (C.apply((b = new C()), c ? [this.constructor, 1, 'icon'] : [this.a, 0, a]), b)
      this.icon = a
      c || this.ua(Me.VISUAL)
    }
    return this
  ...
  Zh.error = function () {
    Zh.a || ((Zh.a = new Zh(null, { status: 0, statusText: '' })), (Zh.a.type = 'error'))
    return Zh.a
  }
  Zh.error = Zh.error
  ...
  Ca(fi.prototype, {
    ...
    se: function (a) {
      ...
      return this.xf < this.oi && b < this.pi
        ? ((c = this.Fi()), this.xf++, (this.Jc[a] = b + 1), (this.uf[c] = a), c)
        : x
    },
    ye: function (a) {
      var b = this.uf[a]
  ...
  function Ji(a, b) {
    ...
    this.b = c = c.appendChild(
      Ki(d, 'DIV', 'position:absolute;bottom:4.55em;left:0.5em;z-index:1;height:0px;direction:ltr')
    )
  ...
  Ji.prototype.f = function () {
    ...
    b.g().type !== Pi
      ...
      : ((b = b.c.Ab()),
        ...
        (c.href = a + [e.lat, e.lng, 22, b.yaw, 90 + b.pitch].join() + ',panorama.day,report'))
  ...
  function Xi(a) {
    ...
    !a ||
      D(a.bx) ||
      D(a.by) ||
      ((b = a.x - a.bx), (c = a.y - a.by), (b = new M(a.x - b / 2, a.y - c / 2)))
    return b
  }
  function Yi(a, b) {
  ...
  p.hg = function (a) {
    ...
    b &&
      this.c &&
      ((b = Zi(this.c)), 0 !== b && ((c = Zi(this.a)), (a = sb(ub(2, a) * (c / b)) / Cb)))
    return a
  }
  function bj(a, b, c, d) {
  ...
  fj.prototype.ca = function (a, b, c, d, e, f) {
        ...
        for (f = m[k], n = gj(f), q = n.length; q--; )
          if ((t = c.geoToPixel(n[q])))
            this.l || ((u = c.w), (t.x -= nb(t.x / u) * u)),
              t.add(b),
              (u = g[(y = f.ta() + '_' + q)]) ? delete g[y] : (u = { marker: f }),
              (h[y] = u),
    ...
    return !l || (l.requested && l.requested === l.total) || (!l.requested && m.length === l.total)
      ? ij.DONE
      : ij.PENDING
  }
  function hj(a, b) {
  ...
  if (ve) {
    ...
    ve &&
      jc !== x &&
      (jc = (oj = /(MSIE\s+|rv\:)([^\);]+)(\)|;)/.exec(navigator.userAgent)) ? +oj[2] : x)
    nj = jc
  ...
  jj.prototype.Ma = function (a, b, c) {
    ...
    if (this.f) {
      ...
      for (b += g.top; (l = m = d.elementFromPoint(a, b)) && l !== f && l !== e && m !== n; ) {
        for (; (q = l.parentNode) && (!sa(q.contains) || !q.contains(f)); ) l = q
        if (
          q === f &&
          (l !== m || 'svg' !== l.nodeName) &&
          0 > h.indexOf((t = l.sd)) &&
        ...
        k || (k = [])
        n = l.style
        k.push({ bg: n.getPropertyValue(lj), $h: n.getPropertyPriority(lj), style: n })
  ...
  pj.prototype.ca = function (a, b, c, d, e, f) {
    ...
    c = d = (d * u) / (ub(2, k) * d)
    this.g ||
      (d % 1 && ((d = pb(d)), (u = c / d), (y = y / u), (J = J / u), (u = ub(2, k) * d)),
      (y = pb(y)),
      (J = pb(J)))
    this.o = c
    k = -d
    ...
    for (h = 0; h < f; h++) {
      n = e[h]
      if ((l = n.data))
        if (((c = b.x - (y - n.x * d)), (m = b.y - (J - n.y * d)), q.bc(l, c, m, d, d), !this.l)) {
  ...
  Dj.prototype.set = function (a, b, c) {
    !this.a ||
      ...
      ((this.b = a), (this.c = b), (this.f = c), this.dispatchEvent(new Ej(Fj(this))))
  }
  function Fj(a) {
  ...
  Ij.prototype.ca = function (a, b, c, d, e) {
    ...
    if (d >= h.min && d <= h.max && ((k = h.C(a, d, e)), (l = k.overlays), (a = l.length)))
      for (l.sort(Se), d = this.b, e = this.Nb, ob = h.opacity, h = 0; h < a; h++)
        (m = l[h]),
          (n = m.S()),
          (q = c.geoToPixel(n.tb())),
          (t = c.geoToPixel(n.rb())),
          ...
          this.c.push(n)
    return !k || (k.requested && k.requested === k.total) || (!k.requested && l.length === k.total)
      ? ij.DONE
      : ij.PENDING
  }
          ...
          if ((d = f && '2d' === f.f)) {
            ...
            d =
              m === d
                ...
                : !d.alpha === !d.alpha && !m.willReadFrequently === !d.willReadFrequently
          }
          d
            ? (h = !1)
            : e && !h
            ? ((f = e), (h = !1))
            : ((f = new Cj(g.ac, g.width, g.height, g.za, '2d', g.xe)), (h = !0))
          break
        case 2:
    ...
    for (a.j = {}; e--; )
      if (((f = d[e]), (h = c[f]), (g = b[f]), null != h)) {
        if (
          ...
          (a.j[f] = h),
          (b[f] = h),
          ($b(h) && $b(g) && (h.lat !== g.lat || h.lng !== g.lng)) || (!$b(h) && h !== g))
        )
          a.f |= Uj[f]
      } else delete b[f]
    return b
  ...
  function xk(a, b, c, d, e) {
    for (
      var f = b.length, g;
      f-- && !((g = b[f]) && g.Ma && ((a = a.concat(g.Ma(c, d, e))), a.length && e));
  ...
  O.prototype.Ub = function () {
    ...
    if (q) {
      ...
      if (n && this.jc)
        for (
          l = 1;
          l <= n && ((h = e + l), m.Ja(h), (g = this.v(2, 0)), m.Ja(e), !q.ca(g, b, m, h, !0, a));
          l++
        );
    }
    this.Vb = Yj
  ...
  O.prototype.C = function (a, b, c, d, e) {
    ...
    this.f.mb() &&
      (this.f.gh(a, b, c, d, e),
      this.f.Fd(Aj.COORD) &&
        ((e = this.f), (e = Wi(e.a, e.c)), 0 < Ui(e) && (Ck(this, -e.x, -e.y), (f = !0))),
      this.f.Fd(Aj.ZOOM) &&
        a === +a &&
        b === +b &&
        c === +c &&
  ...
  O.prototype.s = function (a, b) {
    ...
    this.c.mb() &&
      ...
      !this.o || a || b
        ? 'function' === typeof b &&
          ((d = { camera: Bk(this), zoom: this.b - this.i }), b(d), (d.zoom += this.i), Fk(this, d))
        : ((d = Gj(this.c)),
          (k = Hj(this.c)),
          (l = this.o.duration),
          (g = (this.o.Xg || 1) * d),
  ...
  P.prototype.contains = function (a) {
    var b = this === a
    if (!b && this.b && B(a, K)) for (; !b && a; ) a === this ? (b = !0) : (a = a.Da)
    return b
  }
  ...
  L.prototype.a = function (a) {
    ...
    if (a)
      if (a.l !== this) {
        ...
        (B(a, xi) ? this.j : B(a, fh) ? this.B : B(a, Lk) ? this.A : this.v).remove(b),
          delete b.Lf,
          delete a.Ua
  }
  ...
  function Xk(a, b, c, d, e) {
    ...
    g >= b || (0 < c && h - d)
      ? (--c,
        1 < h - d ? ((d = Xk(a, b, c, d, h)), d.splice(d.length - 1, 1)) : (d = [a[d]]),
        (d = 1 < e - h ? d.concat(Xk(a, b, c, h, e)) : d.concat(a.slice(h, e + 1))))
      : (d = [a[d], a[e]])
    return d
  }
  ...
  Yk.prototype.ca = function (a) {
    ...
    if (this.c < this.f) {
      ...
      if ((d = c.length))
        for (
          a.width = a.height = this.b, b.clearRect(0, 0, this.b, this.b), e = this.g, f = 0;
          f < d;
          f++
        )
          if (((h = c[f]), (g = h.ta()), (l = (k = e[g]) ? k.b : h.getGeometriesForTile(this)))) {
            if (k) h.j().b(this.c) && (k.a = Hf(h, l)), (k = k.a)
              ...
              m = l
              for (
                var q = h.B ? 2 : 0, t = m.length, u = void 0, y = (u = void 0), J = void 0;
                t--;

              )
                if (((u = m[t]), u !== If))
                  for (y = u.Ra, u = y.length; u--; )
                    (J = y[u]), 4 < J.length && (y[u] = Xk(J, 0.36, q || 0, 0, J.length - 1))
              this.g[g] = new cl(l, k)
            }
            if (k) {
              b.save()
  ...
  function fl(a, b, c, d, e, f, g, h, k) {
    ...
    if (e && a === If) b.fillRect(0, 0, f, f)
      ...
      for (f = h; f < k; f++) {
        ...
        else for (l = m[0], b.moveTo(l.x, l.y), h = 1; h < n; h++) (l = m[h]), b.lineTo(l.x, l.y)
        c && b.closePath()
      }
          ...
          for (y = (J = l[m]).distance((T = l[m - 1])); t <= u + y; )
            (la = J.x + (T.x - J.x) * (ea = (t - u) / y)),
              ...
              a.a(la, ea) &&
                (b.save(),
                b.translate(la, ea),
                b.rotate(-Ab((T.y - J.y) / (J.x - T.x)) + (J.x < T.x ? ob : -ob)),
                b.beginPath(),
                b.moveTo(-g, -e),
                b.lineTo(0, e),
                b.lineTo(g, -e),
        ...
        for (f = k.length; f--; ) {
          ...
          if (!(u = m && l === If) && (u = m || q)) {
            ...
            for (
              ...
              if (((Jb = l[rf]), (ia = rf >= la), (na = !ia && rf >= ea), Jb === Tf && J))
                na ? mk++ : nk++
              else {
                lk = Jb.length
                il.length = 2 * lk
  ...
  jl.prototype.o = function (a, b, c, d) {
    ...
    d ||
      ((f = this.a[e])
        ? f.count++
        : ((f = this.v.push([e, a, b, c], this.Pe)), (f.count = 1), (this.a[e] = f)))
  }
  ...
  function nl(a, b) {
    ...
    a.renderBaseBackground || (a.renderBaseBackground = { lower: 3, higher: 2 })
    return a
  }
  ...
  Q.prototype.Ba = function (a) {
    ...
    0 === a.idx &&
      (this.dispatchEvent(
        new Ne(
          this.v.oh,
          (this.i = a.type !== this.fa.a.Nc ? b : 0 < this.fa.Y.length ? this.fa.get(0) : x),
          a.type !== this.fa.a.Lc ? c : 1 < this.fa.Y.length ? this.fa.get(1) : x
        )
      ),
      pl(this))
  }
  ...
  Q.prototype.N = function (a) {
    this.f.type === a ||
      this.wa ||
      ((this.wa = !0), (this.m = this.P(a)), this.m.addEventListener('render', this.C))
    return this
  }
  Q.prototype.setEngineType = Q.prototype.N
  Q.prototype.C = function (a) {
    a.target === this.m &&
      (this.m.removeEventListener('render', this.C), this.m.enter(), this.f.Va(this.O))
  }
  ...
  ul ||
    ...
    ul || ((vl = w.document.getElementsByTagName('script')), (ul = vl[vl.length - 1])))
