;(function (a) {
  a.fn.smartWizard = function (m) {
    ...
    return this.each(function () {
      ...
      function D() {
        c.enableAllSteps
          ? (a(f, b).removeClass('selected').removeClass('disabled').addClass('done'),
            a(f, b).attr('isDone', 1))
          : (a(f, b).removeClass('selected').removeClass('done').addClass('disabled'),
            a(f, b).attr('isDone', 0))
          ...
          ? c.contentCache && h
            ...
            : a.ajax({
                ...
                success: function (c) {
                  ...
                  c &&
                    0 < c.length &&
                    (d.data('hasContent', !0), a(a(d, b).attr('href'), b).html(c), w(e))
                },
              })
          : w(e)
      }
      function w(e) {
        ...
        if ('slide' == c.transitionEffect)
          ...
          e > h
            ...
            : ((nextElmLeft1 = 0 - a(a(d, b).attr('href'), b).outerWidth() + 20),
              (nextElmLeft2 = 0),
          ...
          a(a(g, b).attr('href'), b).hide(), a(a(d, b).attr('href'), b).show(), (h = e), u(g, d)
        return !0
      }
      function u(e, d) {
        ...
        a(d, b).attr('isDone', 1)
        c.cycleSteps ||
          (0 >= h ? a(r).addClass('buttonDisabled') : a(r).removeClass('buttonDisabled'),
          f.length - 1 <= h ? a(q).addClass('buttonDisabled') : a(q).removeClass('buttonDisabled'))
      ...
      if (m && 'init' !== m && 'object' !== typeof m) {
        ...
        if ('setError' === m)
          return (v = Array.prototype.slice.call(x, 1)), y(v[0].stepnum, v[0].iserror), !0
