...
;(function (e) {
  ...
  e.extend(h.prototype, {
    ...
    fnScrollToRow: function (a, b) {
      ...
      0 > i && (i = 0)
      if ((f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== i)
        (d = !0),
      ...
      if (!this.s.skip && !this.s.ingnoreScroll)
        if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0
          ...
          if (this.s.forceReposition || c < this.s.redrawTop || c > this.s.redrawBottom) {
            ...
            Math.abs(c - this.s.lastScrollTop) > b.viewport || this.s.ani || this.s.forceReposition
    ...
    _fnDrawCallback: function () {
      ...
      this.s.redrawBottom =
        c + d > b.scroll - b.viewport - b.row ? b.scroll - b.viewport - b.row : c + d
      this.s.skip = !1
