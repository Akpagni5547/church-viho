!(function () {
        ...
        ;(t = O.store.elements[n]),
          ...
          g(t)
            ...
            : v(t) &&
              ...
              t.domEl.setAttribute(
                'style',
                t.styles.inline + t.styles.transform.initial + t.styles.transition.instant
              ),
              p('reset', t),
              (t.revealing = !1))
      })
  ...
  ;(e.prototype.defaults = {
    ...
    (e.prototype.reveal = function (e, s, a, d) {
      ...
      a &&
        'number' == typeof a &&
        ((w = i()), (g = O.sequences[w] = { id: w, interval: a, elemIds: [], active: !1 }))
      for (var v = 0; v < y.length; v++)
        (p = y[v].getAttribute('data-sr-id')),
          ...
          (O.tools.isMobile() && !m.config.mobile) || !O.isSupported()
            ...
            : m.revealing ||
              m.domEl.setAttribute('style', m.styles.inline + m.styles.transform.initial)
      return (
        !d &&
          O.isSupported() &&
          (c(e, s, a),
